        ...
        switch ($field->type) {
            ...
            case FieldDefinition::TYPE_NUMBER:
                ...
                <input
                    ...
                    <?php if ($field->minValue !== null) : ?>min="<?php echo esc_attr((string) $field->minValue); ?>"<?php endif; ?>
                    <?php if ($field->maxValue !== null) : ?>max="<?php echo esc_attr((string) $field->maxValue); ?>"<?php endif; ?>
                />
                <?php
                break;
            ...
            default:
                ...
                <input
                    ...
                    value="<?php echo esc_attr($value ?? ''); ?>"
                    class="regular-text"
                    <?php if ($field->maxLength !== null) : ?>maxlength="<?php echo esc_attr((string) $field->maxLength); ?>"<?php endif; ?>
                />
                <?php
        }
    }
